...
int run_example_QAOA(int n, int * values) {
    ...
    cout << "-----------------------------------------------------------------------------------" << endl;
    for (int i = 0; i < min(lumping.dimension(), 20); i++) {
    ...
    CC inner[lumping.dimension()][lumping.dimension()];
    for (int i = 0; i < lumping.dimension(); i++) {
        for (int j = 0; j < lumping.dimension(); j++) {
...
int example_QAOA_10_1() { // Should be 8?
    ...
    int n = 10, N = pow(2,n);
    int values[N] = {20, 17, 19, 17, 19, 16, 18, 16, 19, 18, 18, 17, 18, 17, 17, 16, 17, 15, 16, 15, 17, 15, 16, 15, 16, 16, 15, 15, 16, 16, 15, 15, 19, 
...
int example_QAOA_10_2() { // Should be 7?
    ...
    int n = 10, N = pow(2,n);
    int values[N] = {14, 14, 14, 14, 14, 14, 14, 14, 13, 13, 13, 13, 12, 12, 12, 12, 13, 13, 13, 13, 13, 13, 13, 13, 14, 14, 14, 14, 13, 13, 13, 13, 13, 
...
int example_QAOA_10_3() { // Should be 10?
    ...
    int n = 10, N = pow(2,n);
    int values[N] = {19, 19, 20, 20, 18, 18, 19, 19, 18, 17, 18, 19, 17, 16, 17, 18, 19, 19, 21, 21, 19, 19, 21, 21, 18, 17, 18, 19, 19, 18, 
...
int example_QAOA_10_4() { // Should be 11?
    ...
    int n = 10, N = pow(2,n);
    int values[N] = {24, 25, 23, 24, 21, 22, 20, 22, 22, 24, 22, 24, 21, 23, 21, 24, 22, 23, 21, 22, 19, 20, 18, 20, 21, 23, 21, 23, 19, 21, 19, 22, 
...
int example_QAOA_4_1() { // Should be 4?
    ...
    int n = 4, N = pow(2, n);
    int values[N] = {8, 8, 7, 9, 8, 9, 6, 9, 7, 8, 7, 8, 9, 9, 8, 8};
...
int example_QAOA_4_2() { // Should be 4?
    ...
    int n = 4, N = pow(2, n);
    int values[N] = {6, 7, 5, 6, 7, 7, 6, 6, 6, 6, 6, 7, 6, 4, 6, 5};
