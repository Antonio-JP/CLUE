...
python3 q_order.py -m 5 -M 15 -r 50;
git add [result]q_order_clue.csv; git commit -m "Table 1 (ORDER) up to order 15"; git push;
python3 q_search.py -m 5 -M 15 -r 50;
git add [result]q_search_clue.csv; git commit -m "Table 1 (GROVER) up to order 15"; git push;
# Executing examples Up to order 20
python3 q_sat.py -t direct -m 16 -M 20 -r 50;
git add [result]q_sat_direct.csv; git commit -m "Table 1 (SAT) up to order 20"; git push;
python3 q_maxcut.py -t direct -m 16 -M 20 -r 50;
git add [result]q_maxcut_direct.csv; git commit -m "Table 1 (MAXCUT) up to order 20"; git push;
python3 q_order.py -m 16 -M 20 -r 50;
git add [result]q_order_clue.csv; git commit -m "Table 1 (ORDER) up to order 20"; git push;
python3 q_search.py -m 16 -M 20 -r 50;
